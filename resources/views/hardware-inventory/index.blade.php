    ...
    <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
      <div class="overflow-hidden">
        ...
        <div class="flex float-left">
          ...
          <div class="mb-6 xl:w-96">
             <x-button variant="success" size="sm" href="hardware/create"> Create Hardware Inventory </x-button>
          </div>
            ...
            @foreach ($inventory as $key => $item)
              <tr class="border-b dark:border-neutral-500">
                ...
                <td class="flex m-rwhitespace-nowrap px-6 py-4">
                    <x-button class="mr-2" variant="success" size="sm" href="hardware/{{ $item->id }}/edit"> Edit </x-button>
                   <form action="/hardware/{{ $item->id }}" method="POST">
                        @csrf
                        @method('delete')
