    ...
    <div class="p-6 overflow-hidden bg-white rounded-md shadow-md dark:bg-dark-eval-1">
        ...
        <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
            ...
            <div class="overflow-hidden">
                ...
                <div class="mb-6 xl:w-96">
                    <x-button variant="success" size="sm" href="users/create"> Create User </x-button>
                 </div>
                     ...
                     <tbody>
                            ...
                            <tr class="border-b ">
                                    ...
                                    <td class="flex m-rwhitespace-nowrap px-6 py-4">
                                        <x-button class="mr-2" variant="success" size="sm" href="users/{{ $user->id }}/edit"> Edit </x-button>
